            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data">    
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="tinymce-editor" name="deskripsi" placeholder="Masukkan detail uraian pembelanjaan....">
                            </textarea>
                    </div>
                    <div class="form-group">
...
if (isset($_POST['save'])) {
    ...
    if($row1['jml']==0){
        $conn->query("INSERT INTO barang VALUES (NULL, '$nama', '$deskripsi', '$stok', '$hrg_jual', CURRENT_TIMESTAMP);");
